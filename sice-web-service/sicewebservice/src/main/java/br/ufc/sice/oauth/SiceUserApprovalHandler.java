...
public class SiceUserApprovalHandler extends ApprovalStoreUserApprovalHandler {
	...
	public void setClientDetailsService(ClientDetailsService clientDetailsService) {
		System.out.println("SiceUserApprovalHandler --- setClientDetailsService");
	...
	public void setUseApprovalStore(boolean useApprovalStore) {
		System.out.println("SiceUserApprovalHandler --- setUseApprovalStore");
	...
	public AuthorizationRequest checkForPreApproval(AuthorizationRequest authorizationRequest,
		...
		System.out.println("SiceUserApprovalHandler --- checkForPreApproval");
